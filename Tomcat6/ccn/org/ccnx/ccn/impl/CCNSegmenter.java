...
import org.ccnx.ccn.impl.CCNTrieTree.Vertex;
	...
	throws InvalidKeyException, InvalidAlgorithmParameterException, IOException, SignatureException, NoSuchAlgorithmException {
		...
		for (int i=0; i < blockCount; ++i) {
			...
			if(testhash!=null){
				...
				Vertex vertex = testhash.FindPath("/localhost/ROOT", path);
				System.out.println("CCNSegmenter 815 buildBlocks path:"+path);
				if(vertex!=null)
				{
					synchronized(vertex){
